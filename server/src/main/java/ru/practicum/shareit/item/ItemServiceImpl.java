...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDtoResponse getItemById(Long itemId) {
        ...
        return ItemMapper.mapToItemDtoResponseWithComments(item, comments);
    }
    ...
    public ItemDto createItem(Long userId, ItemDto request) {
        ...
        if (request.getRequestId() != null) {
            if (itemRequestRepository.findById(request.getRequestId()).isPresent()) {
                item.setRequest(itemRequestRepository.findById(request.getRequestId()).orElseThrow());
            }
        }
