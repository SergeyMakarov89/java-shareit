...
public class ItemMapper {
    ...
    public static ItemDtoResponse mapToItemDtoResponseWithComments(Item item, List<Comment> comments) {
        log.info("Запустили метод корвертации вещи из айтем в айтемдтореспонс с комментариями в айтеммаппере");
